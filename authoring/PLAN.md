...
| | |
|---|---|
| Thân bài đã viết | **23 / 122** |
| Đề case đã đặc tả | **30** (29 từ blueprint + 1 viết tay) |
| Rubric thiếu mô tả 4 mức | **34 / 40** (RM-A1, RM-A2, RM-A3, RM-B1, RM-B2 đã xong) |
