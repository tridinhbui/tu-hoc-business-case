...
4. **Tự giải bài tập và đề case của mình** trong đúng thời lượng ghi trên bài. Số trong khung trả lời phải nhân ra đúng — kiểm bằng máy tính, đừng ước lượng.
5. **Viết tiếng Việt cho người học Việt Nam**, thuật ngữ tiếng Anh giữ nguyên khi đó là cách người trong ngành thật sự gọi (issue tree, top-down, unit economics). Không dịch cưỡng ép.
6. **Không sửa file trong `seed/`.** Chúng được sinh ra từ script. Sửa ở `authoring/` rồi chạy lại.
