...
for table in ["level_gates", "capstones", "path_items", "learning_paths", "assumption_bank", "panel_questions",
              ...
              # lesson_blocks holds authored bodies and is rewritten by build-authored.py right after this file
              "rubrics", "lesson_blocks", "lesson_skills", "lessons", "module_skills", "module_prereqs", "modules", "tracks",
              "skill_levels", "skills"]:
